...
export default function Home() {
  return (
    <div className="relative dark:bg-[#17202C] overflow-hidden">
      <div className="max-w-7xl mx-auto">
        <div className="relative z-10 pb-8 dark:bg-[#17202C] sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
          <svg
